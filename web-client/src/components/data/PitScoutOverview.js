...
import { getMaximums, getMaximumsAcrossPitScouting, getTeamNames, getTeamNamesAcrossMatchScouting, getTeamNamesAcrossPitScouting, getTeamOverview, getTeamOverviewAcrossMatchScouting, getTeamOverviewAcrossPitScouting } from "../../scripts/api"
...
const PitScoutOverview = ({ state, setState }) => {
    ...
    useEffect(() => {
        getTeamNamesAcrossPitScouting(setQueryOptions)

        getMaximumsAcrossPitScouting((maximums) => {
            setAxisMaximums(maximums)
        })
    }, [])

    useEffect(() => {
        if (query) getTeamOverviewAcrossPitScouting(query, setQueriedData)
    }, [query])
...
export default PitScoutOverview